...
Rapor icin: `RAPOR.md`
Kisa ozet icin: `OZET_SONUC.md`
Sunum notlari icin: `SUNUM.md`
Hazir slayt dosyasi: `SUNUM_SLIDES.pptx`
Sunum PDF: `SUNUM_SLIDES.pdf`

Bu dosyalar kopyala-yapistir seklinde kullanilabilir.
